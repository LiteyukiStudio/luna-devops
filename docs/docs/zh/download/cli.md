...
从仓库运行 CLI、更新 OpenAPI 命令和执行验证的方法见[源码开发与验证](/develop/cli-development)。
...
具体安装方式见[安装与使用](./installation)，源码开发见[源码开发与验证](/develop/cli-development)，制品校验见[CLI 发布](/develop/cli-release)。
