...
func (h *Handler) ListDataRetentionCatalog(ctx *gin.Context) {
...
func (h *Handler) PreviewDataRetention(ctx *gin.Context) {
	if !h.requirePlatformAdmin(ctx) {
		return
	}
...
func (h *Handler) CleanupDataRetention(ctx *gin.Context) {
