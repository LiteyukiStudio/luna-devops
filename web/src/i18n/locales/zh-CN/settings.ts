const settings = {
  ...
  registration: {
    ...
    emailRegistrationDescription: '开启后，新用户可通过邮箱验证码创建账号。必须先配置全局邮件服务。',
  ...
  mail: {
    tab: '邮件服务',
    title: '全局邮件服务',
    description: '统一配置注册验证码和个人邮件通知使用的 SMTP 服务。',
    host: 'SMTP 主机',
    hostRequired: '请输入 SMTP 主机。',
    port: 'SMTP 端口',
    security: '连接安全',
    securityNone: '无加密',
    securityStartTLS: 'STARTTLS（先连接后升级加密）',
    securityTLS: 'TLS（直接加密连接）',
    username: 'SMTP 用户名',
    password: 'SMTP 密码',
    passwordHint: '编辑时留空会保留现有密码；密码不会回显。',
    fromAddress: '发件邮箱',
    fromName: '发件人名称',
    personalEmailCooldown: '个人邮件聚合冷却（秒）',
    personalEmailCooldownHint: '第一封个人事件邮件立即发送；冷却期内发生的后续事件会按用户合并，并在冷却结束后发送下一封。每封最多汇总 20 个事件，超出部分在后续周期发送。范围 0–3600 秒，默认 60 秒；0 表示不等待。注册验证码、账号找回、测试邮件和共享 SMTP 不受影响。',
    personalEmailCooldownInvalid: '请输入 0 到 3600 之间的整数。',
    testRecipient: '测试收件邮箱',
    testRecipientHint: '测试只会发送到此地址，不会保存为通知收件人。',
    sendTest: '发送测试邮件',
    save: '保存邮件服务',
    saved: '全局邮件服务已保存',
    testSent: '测试邮件已发送',
    loadFailedTitle: '邮件服务加载失败',
    loadFailedDescription: '请确认当前账号具有平台管理员权限，或稍后重试。',
  },
  configDefinitions: {
    ai: {
