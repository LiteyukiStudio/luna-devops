...
type Application struct {
	...
	// DataRetentionMode is retained only for pre-volume-center schema compatibility.
	// Runtime deletion and API responses use DeploymentVolumeMount relations instead.
	DataRetentionMode string         `gorm:"not null;default:retain" json:"-"`
