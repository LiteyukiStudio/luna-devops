...
For a click-through walkthrough, see [Deploy a Web Project](/en/start/first-project). It uses `snowykami/neo-blog` as the example and goes from project space creation to public access.
