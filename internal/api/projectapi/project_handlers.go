...
func (h *Handler) ListProjects(ctx *gin.Context) {
	...
	if projectID := h.host.AIConversationProjectID(ctx); projectID != "" {
...
func (h *Handler) ListProjectPins(ctx *gin.Context) {
	user, ok := h.currentUser(ctx)
	if !ok {
		return
	}
...
func (h *Handler) PinProject(ctx *gin.Context) {
...
func (h *Handler) UnpinProject(ctx *gin.Context) {
	user, project, ok := h.authorizeProject(ctx, authz.ActionProjectPin)
	if !ok {
		return
	}
...
func (h *Handler) UpdateProjectOrder(ctx *gin.Context) {
	user, ok := h.currentUser(ctx)
	if !ok {
		return
	}
...
func (h *Handler) ListProjectMembers(ctx *gin.Context) {
...
func (h *Handler) SearchProjectMemberCandidates(ctx *gin.Context) {
	_, project, ok := h.authorizeProject(ctx, authz.ActionProjectManage)
	if !ok {
		return
	}
...
func (h *Handler) CreateProjectMember(ctx *gin.Context) {
...
func (h *Handler) UpdateProjectMember(ctx *gin.Context) {
...
func (h *Handler) DeleteProjectMember(ctx *gin.Context) {
	user, project, ok := h.authorizeProject(ctx, authz.ActionProjectManage)
	if !ok {
		return
	}
...
func (h *Handler) projectHasAnotherOwner(ctx context.Context, projectID, memberID string) bool {
	return h.host.ProjectHasAnotherOwner(ctx, projectID, memberID)
}
...
func (h *Handler) projectResponse(project model.Project, ctx context.Context) projectResponse {
...
func (h *Handler) recordProjectUsage(userID string, projectID string, ctx context.Context) {
	now := time.Now()
...
func (h *Handler) projectDashboardOrder(userID string, projectID string, ctx context.Context) int {
	var member model.ProjectMember
