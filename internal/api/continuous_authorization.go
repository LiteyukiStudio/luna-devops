...
func (h *Handlers) continuousAuthorizationCheckInterval() time.Duration {
	if h != nil && h.continuousAuthorizationInterval > 0 {
		return h.continuousAuthorizationInterval
	}
...
func (h *Handlers) monitorContinuousAuthorization(
	ctx context.Context,
	binding continuousAuthorizationBinding,
...
func (h *Handlers) monitorContinuousAuthorizationWithInterval(
	ctx context.Context,
	binding continuousAuthorizationBinding,
	authorizationAllowed func(context.Context, model.User) bool,
	revoke func(),
...
func (h *Handlers) continuousAuthorizationActive(
	ctx context.Context,
	binding continuousAuthorizationBinding,
	authorizationAllowed func(context.Context, model.User) bool,
) bool {
...
func (h *Handlers) continuousAuthorizationIdentityState(ctx context.Context, binding continuousAuthorizationBinding) (continuousAuthorizationState, bool) {
