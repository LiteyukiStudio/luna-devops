...
- [x] 删除项目空间、账号和运行集群中的 kubectl 入口，同步前端类型、多语言文案与交互测试。
- [x] 从 OpenAPI、独立 Luna CLI、Agent 工具目录与公开文档中删除已下线能力，保留平台管理员配置运行集群所需的上游 kubeconfig。
- [x] 完成后端、前端、数据库迁移、OpenAPI、Agent、文档与 Helm 相关验证。
