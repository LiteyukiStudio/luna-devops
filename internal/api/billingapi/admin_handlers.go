...
func (h *Handler) ListBillingRateRules(ctx *gin.Context) {
...
func (h *Handler) UpdateBillingRateRules(ctx *gin.Context) {
...
func (h *Handler) CreateBillingWalletTransaction(ctx *gin.Context) {
	user, ok := h.currentUser(ctx)
	if !ok {
		return
	}
...
func (h *Handler) CreateExternalBillingTransaction(ctx *gin.Context) {
