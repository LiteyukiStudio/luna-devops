...
import { RuntimeDataVolumesEditor } from '@/pages/applications/deployments/editor/runtime/application-deployment-data-volumes-editor'
import { ApplicationDeploymentHooksEditor } from '@/pages/applications/deployments/editor/runtime/application-deployment-hooks-editor'
import { KubernetesAdvancedFields } from '@/pages/applications/deployments/editor/runtime/application-deployment-kubernetes-advanced-fields'
import { RuntimeResourceFields } from '@/pages/applications/deployments/editor/runtime/application-deployment-resource-fields'
import { ApplicationDeploymentRuntimeSecretsEditor } from '@/pages/applications/deployments/editor/runtime/application-deployment-runtime-secrets-editor'
import { ServicePortsEditor } from '@/pages/applications/deployments/editor/runtime/application-deployment-service-ports-editor'
import { ApplicationRuntimeConfigSelector } from '@/pages/applications/deployments/editor/runtime/application-runtime-config-selector'
import { ApplicationDeploymentBuildSettingsFields, ApplicationDeploymentSourceFields } from '@/pages/applications/deployments/editor/source/application-deployment-source-fields'
          ...
          <div className="grid gap-3 overflow-y-auto px-6 py-4 pb-6">
            ...
            >
              <div className="grid gap-4">
                <Controller
                  control={form.control}
                  name="buildHooksEnabled"
                  render={({ field }) => (
                    <ControlledCheckboxField description={t('deploymentsPage.deploymentHooksEnabledHint')} field={field}>
