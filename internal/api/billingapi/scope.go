...
func (h *Handler) billingScopeForUser(ctx *gin.Context, user model.User) (billingScope, bool) {
	scope := billingScope{}
...
func (h *Handler) ensureBillingProjectsExist(ctx *gin.Context, projectIDs []string) bool {
	if len(projectIDs) == 0 {
		return true
	}
	var count int64
