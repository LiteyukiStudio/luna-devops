...
See [Source Development and Verification](/en/develop/cli-development) for repository commands, OpenAPI regeneration, and validation.
...
See [Install and Use](./installation), [Source Development and Verification](/en/develop/cli-development), and [CLI Releases](/en/develop/cli-release) for details.
