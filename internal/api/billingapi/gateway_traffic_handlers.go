...
const systemComponentGatewayTrafficProbe = model.SystemComponentGatewayTrafficProbe
...
func (h *Handler) GetGatewayTrafficStatus(ctx *gin.Context) {
...
func (h *Handler) CreateGatewayTrafficUsage(ctx *gin.Context) {
	actorID := ""
...
func (h *Handler) CreateGatewayTrafficProbeHello(ctx *gin.Context) {
...
func (h *Handler) gatewayRouteBelongsToRuntimeCluster(route model.GatewayRoute, clusterID string, ctx context.Context) bool {
