const settings = {
  ...
  ai: {
    tab: 'AI 助手',
    enabled: '启用站点 AI 助手',
    enabledHint: '部署级开关、Agent 健康、Provider 和用户授权仍会共同决定功能是否可用。',
    ...
    fallbackModel: '备用模型',
    modelPricing: '模型价格版本',
    modelPricingHint: '填写版本化价格配置 JSON 数组。',
    modelPricingInvalid: '模型价格配置必须是有效的 JSON 数组。',
    baseUrl: 'Provider Base URL',
    baseUrlHint: '仅接受受平台出站策略允许的 HTTPS 地址。',
    apiKey: 'Provider API Key',
    apiKeyHint: '密钥由平台加密保存，编辑时不回显。',
    secretUnchanged: '留空表示不修改',
    accessMode: '访问模式',
    accessAdmins: '仅平台管理员',
    accessAllowlist: '用户白名单',
    accessAll: '全部已登录用户',
    userIds: '用户 ID 白名单',
    projectIds: '项目空间 ID 范围',
    idsHint: '每行一个 ID，也可使用逗号分隔。',
    userConcurrentRuns: '用户并发 Run',
    userDailyTokens: '用户每日 Token',
    projectConcurrentRuns: '项目空间并发 Run',
    runMaxToolCalls: '单 Run 最大工具调用',
    platformDailyCostHard: '平台每日硬成本上限',
    platformDailyCostSoft: '平台每日软成本告警',
    conversationDays: '会话保留天数',
    runEventDays: 'Run 事件保留天数',
    checkpointDays: 'Checkpoint 保留天数',
    saved: 'AI 助手配置已保存',
    saveFailed: 'AI 助手配置保存失败',
    providerRequired: '启用助手前必须配置 Provider、HTTPS Base URL 和默认模型。',
    hardLimitRequired: '向全部已登录用户开放前必须设置大于 0 的每日硬成本上限。',
  },
  registration: {
    tab: '注册与登录',
