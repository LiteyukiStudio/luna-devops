...
func (h *Handlers) observeArtifactRegistries(parent context.Context, user model.User, registries []model.ArtifactRegistry) {
...
func (h *Handlers) observeArtifactRegistry(parent context.Context, user model.User, registry *model.ArtifactRegistry) {
