...
| Advanced | `BUILD_PRIVATE_EGRESS_CIDRS` | Empty | Extra private HTTPS CIDRs builds may access; set for internal registries or mirrors. DNS allows kube-dns/CoreDNS and port 53 by default. |
