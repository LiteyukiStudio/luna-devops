...
{
  "schemaVersion": 1,
  "title": "选择并配置 PostgreSQL",
  "description": "找到 1 个可直接安装的平台模板。",
  "template": "catalog",
  "display": {
    "density": "comfortable",
    "selection": "none"
  ...
  "cards": [
    {
      ...
      "presentation": {
        ...
        "title": "PostgreSQL",
        "subtitle": "16-alpine",
        "description": "适用于事务数据和关系型业务数据。",
        "icon": {
          "type": "asset",
          "assetRef": "app-template:postgresql:icon",
          "alt": "PostgreSQL"
        },
        "badges": [
          { "label": "平台模板", "tone": "success" },
          { "label": "数据库", "tone": "neutral" }
        ]
      },
      "sourceRefs": [
        {
      ...
      "blocks": [
        {
          ...
          "type": "key_value",
          "items": [
            { "label": "版本", "value": "16-alpine", "format": "code" },
            { "label": "来源", "value": "平台模板", "format": "status" }
          ]
        }
      ],
      "form": {
      ...
      "actions": [
        {
          ...
          },
          {
            ...
            "value": { "type": "field", "fieldId": "applicationIdentifier" }
          },
          {
            "target": "/clusterId",
            "value": { "type": "field", "fieldId": "clusterId" }
          ...
          },
          {
            ...
            "value": { "type": "field", "fieldId": "password" }
          },
          {
            "target": "/installNow",
            "value": { "type": "field", "fieldId": "installNow" }
          }
          ]
        }
      ]
