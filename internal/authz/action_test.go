...
func TestRequiredAccessTokenScopeUsesFineGrainedProjectRoutes(t *testing.T) {
	tests := []struct {
		...
		{"/api/v1/mail/settings", "GET", string(ActionConfigRead)},
		{"/api/v1/mail/settings", "PUT", string(ActionConfigWrite)},
		{"/api/v1/mail/settings/test", "POST", string(ActionConfigWrite)},
		{"/api/v1/me/notification-preferences", "GET", string(ActionUserRead)},
		{"/api/v1/me/notification-preferences", "PUT", string(ActionUserWrite)},
		{"/api/v1/me/notification-channels/:channelId/test", "POST", string(ActionUserWrite)},
		{"/api/v1/me/notification-deliveries", "GET", string(ActionUserRead)},
