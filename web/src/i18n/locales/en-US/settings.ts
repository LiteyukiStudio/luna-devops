const settings = {
  ...
  ai: {
    ...
    enabledHint: 'The deployment switch, Agent health, Provider, and user authorization still determine availability.',
    providerType: 'Provider type',
    notConfigured: 'Not configured',
    openAICompatible: 'OpenAI-compatible API',
    defaultModel: 'Default model',
    fallbackModel: 'Fallback model',
    modelPricing: 'Model pricing versions',
    modelPricingHint: 'Enter the versioned pricing configuration as a JSON array.',
    modelPricingInvalid: 'Model pricing must be a valid JSON array.',
    baseUrl: 'Provider base URL',
    baseUrlHint: 'Only HTTPS addresses allowed by the platform egress policy are accepted.',
    ...
    accessAdmins: 'Platform administrators only',
    accessAllowlist: 'User allowlist',
    accessAll: 'All authenticated users',
    userIds: 'User ID allowlist',
    projectIds: 'Project space ID scope',
    idsHint: 'Enter one ID per line or separate IDs with commas.',
    userConcurrentRuns: 'Concurrent runs per user',
    userDailyTokens: 'Daily tokens per user',
    projectConcurrentRuns: 'Concurrent runs per project',
    runMaxToolCalls: 'Maximum tool calls per run',
    platformDailyCostHard: 'Platform daily hard cost limit',
    platformDailyCostSoft: 'Platform daily soft cost alert',
    conversationDays: 'Conversation retention days',
    runEventDays: 'Run event retention days',
    checkpointDays: 'Checkpoint retention days',
    saved: 'AI assistant settings saved',
    saveFailed: 'Could not save AI assistant settings',
    providerRequired: 'Configure a Provider, HTTPS base URL, and default model before enabling the assistant.',
    hardLimitRequired: 'Set a daily hard cost limit greater than zero before enabling access for all authenticated users.',
  },
  registration: {
