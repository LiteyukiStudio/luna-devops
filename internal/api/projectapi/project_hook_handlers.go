...
func (h *Handler) ListProjectHookConfigs(ctx *gin.Context) {
...
func (h *Handler) CreateProjectHookConfig(ctx *gin.Context) {
...
func (h *Handler) UpdateProjectHookConfig(ctx *gin.Context) {
	user, project, ok := h.authorizeProject(ctx, authz.ActionProjectManage)
	if !ok {
		return
	}
...
func (h *Handler) DeleteProjectHookConfig(ctx *gin.Context) {
	user, project, ok := h.authorizeProject(ctx, authz.ActionProjectManage)
	if !ok {
		return
	}
...
func (h *Handler) ListProjectHookRuns(ctx *gin.Context) {
	if _, _, ok := h.authorizeProject(ctx, authz.ActionProjectRead); !ok {
		return
	}
...
func (h *Handler) GetProjectHookRunLog(ctx *gin.Context) {
...
func (h *Handler) projectHookConfigFromInput(ctx *gin.Context, user model.User, projectID string, input projectHookConfigInput, hookID string) (model.ProjectHookConfig, bool) {
