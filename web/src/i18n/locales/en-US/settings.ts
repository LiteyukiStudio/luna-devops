const settings = {
  ...
  registration: {
    ...
    emailRegistrationDescription: 'Let new users create accounts with an email verification code. Configure the global mail service first.',
  ...
  mail: {
    tab: 'Mail service',
    title: 'Global mail service',
    description: 'Configure the SMTP service shared by registration codes and personal email notifications.',
    host: 'SMTP host',
    hostRequired: 'Enter an SMTP host.',
    port: 'SMTP port',
    security: 'Connection security',
    securityNone: 'No encryption',
    securityStartTLS: 'STARTTLS (upgrade after connecting)',
    securityTLS: 'TLS (encrypted connection)',
    username: 'SMTP username',
    password: 'SMTP password',
    passwordHint: 'Leave empty when editing to keep the current password. The password is never returned.',
    fromAddress: 'Sender address',
    fromName: 'Sender name',
    personalEmailCooldown: 'Personal email aggregation cooldown (seconds)',
    personalEmailCooldownHint: 'The first personal event email is sent immediately. Later events during the cooldown are combined per user and sent when it ends. Each digest contains at most 20 events; excess events continue in later cycles. Enter 0–3600 seconds; the default is 60. Zero sends without waiting. Registration, account recovery, test email, and shared SMTP are unaffected.',
    personalEmailCooldownInvalid: 'Enter a whole number from 0 to 3600.',
    testRecipient: 'Test recipient',
    testRecipientHint: 'The test is sent only to this address and does not save it as a notification recipient.',
    sendTest: 'Send test email',
    save: 'Save mail service',
    saved: 'Global mail service saved',
    testSent: 'Test email sent',
    loadFailedTitle: 'Could not load mail service',
    loadFailedDescription: 'Confirm that the current account is a platform administrator, or try again later.',
  },
  configDefinitions: {
    ai: {
