...
import { branchOptions, defaultTargetImageRef, deploymentTargetImageRef, firstSelectableDeploymentTarget, registryInputPrefix, registryOptionLabel } from '@/pages/applications/application-config-utils'
