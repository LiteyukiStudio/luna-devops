...
- 动作默认需要用户点击。只有无副作用且不改变用户当前工作上下文的
  `refresh_query` 可以由前端在当前资源仍匹配时自动执行。
...
```json
{
  "route": "/projects/:projectId/apps/:applicationId",
  "projectId": "prj_xxx",
  "applicationId": "app_xxx",
  "deploymentTargetId": "dplt_xxx",
