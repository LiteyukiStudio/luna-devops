...
var configDefinitions = []configDefinition{
	...
	},
	{
		...
		Label:       "保留近期轮次数",
		Description: "压缩时固定保留的最近对话轮数，范围 1–16，默认 4。不能超过最多保留近期轮次数。",
		Type:        "number",
		Default:     "4",
	},
	{
		...
		Label:       "最多保留近期轮次数",
		Description: "单次请求中最多向模型展示的近期对话轮数，范围 2–32，默认 8。",
		Type:        "number",
		Default:     "8",
	},
	{
		...
		Label:       "未压缩轮次阈值",
		Description: "历史轮次超过该数量后强制触发压缩，范围 4–200，默认 24。",
		Type:        "number",
		Default:     "24",
	},
	{
		...
		Label:       "单次压缩最大轮次数",
		Description: "一次上下文编译最多送入压缩器的历史轮次数，范围 8–500，默认 96。",
		Type:        "number",
		Default:     "96",
	},
	{
		...
		Description: "生成历史摘要时单批允许的输入 Token 预算，范围 4–128K，默认 24K。",
		Type:        "number",
		Default:     "24",
	},
	{
		...
		Label:       "摘要最大输出 Token",
		Description: "单次摘要生成允许的最大输出 Token 数，范围 200–8000，默认 1500。",
		Type:        "number",
		Default:     "1500",
	},
	{
		...
		Description: "每轮历史会话中工具调用与结果允许进入上下文的 Token 预算，范围 1–64K，默认 4K。",
		Type:        "number",
		Default:     "4",
	},
	{
		...
		Label:       "模型最大输出 Token",
		Description: "助手每次回复允许的最大输出 Token 数，范围 256–16384，默认 4096。",
		Type:        "number",
		Default:     "4096",
	},
	{
		...
		Label:       "Run 最大模型轮次",
		Description: "单个 Run 内模型生成（含工具调用）的最大轮次数，用于防止失控循环，范围 1–200，默认 48。",
		Type:        "number",
		Default:     "48",
	},
	{
		...
		Label:       "用户输入大小上限（KB）",
		Description: "单轮用户输入允许的最大字节数，范围 8–1024K，默认 48K。",
		Type:        "number",
		Default:     "48",
	},
	{
		...
		Label:       "路由跳转动作有效期（秒）",
		Description: "navigate_to_route 生成的跳转动作可被前端执行的秒数，范围 10–600，默认 60。",
		Type:        "number",
		Default:     "60",
	},
	{
		...
		Label:       "工具结果上下文预算（KB）",
		Description: "单个工具结果进入模型前的字节上限，超出时按元素粒度截断，范围 4–512K，默认 24K。",
		Type:        "number",
		Default:     "24",
	},
	{
		...
		Label:       "交互卡片修复上限",
		Description: "模型生成的交互卡片参数校验失败后允许自动修正的最大次数，范围 1–10，默认 3。",
		Type:        "number",
		Default:     "3",
	},
	{
