...
func (h *Handler) ListAIModels(ctx *gin.Context) {
...
func (h *Handler) ListAIModelConfigs(ctx *gin.Context) {
...
func (h *Handler) CreateAIModel(ctx *gin.Context) {
...
func (h *Handler) UpdateAIModel(ctx *gin.Context) {
	user, ok := h.currentUser(ctx)
	if !ok {
		return
	}
...
func (h *Handler) DeleteAIModel(ctx *gin.Context) {
	user, ok := h.currentUser(ctx)
	if !ok {
		return
	}
